...
unsigned int nStakeMinAge = 60 * 60 * 24 * 1;	// 最小币龄: 1d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;	// 最大币龄: 30d
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing



int64 nChainStartTime = 1449116007;//utc时间
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "TTCOIN and TTCOIN are gooDSADWQZIKJJNGIUABVUS";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0x380eda436ed5a9e0fe338c909c0891aca30a82436363e99ca887099f1d4a9a1a"));
